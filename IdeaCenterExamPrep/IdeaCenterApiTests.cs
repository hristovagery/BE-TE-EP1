...

{
    ...
    public class IdeaCenterApiTests
    {
        ...
        private const string StaticToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..pjDQOpXUa1K8OUX698EKHhJT9goUPKVRstL4fV39DN4";

        private const string LoginEmail = "gery23@example.com";
        ...
        private string GetJwtToken(string email, string password)
        {
            ...
            {
                throw new InvalidOperationException($"Failed to authenticate. Status code: {response.StatusCode}, Content");
            }
